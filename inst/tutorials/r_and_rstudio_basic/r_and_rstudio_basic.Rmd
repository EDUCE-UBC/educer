...
### Check Your Understanding {#object}
...
### Check Your Understanding {#no-function}
...
- [Invalid 'type' of argument](#invalid-type)
- [Missing quotations and equal signs](#types)
- [Missing dependencies](#dependency)
- [Package not found](#no-package)
- [Function not found](#no-function)
