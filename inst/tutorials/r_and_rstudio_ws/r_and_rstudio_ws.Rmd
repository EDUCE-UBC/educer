...
```{r step_1, echo=FALSE, out.width = '100%'}
knitr::include_graphics("/images/what_is_r_step_1.png")
```
...
```{r step_2, echo=FALSE, out.width = '100%'}
knitr::include_graphics("/images/what_is_r_step_2.png")
```
...
```{r step_3, echo=FALSE, out.width = '100%'}
knitr::include_graphics("/images/what_is_r_step_3.png")
```
...
```{r context = "server"}
example_script_file <- read_file("/scripts/example_script.R")
...
```{r new_project, echo=FALSE, out.width = '100%'}
