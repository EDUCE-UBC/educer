...
author: >
  ...
  Based on notes by Florent Mazel, Kim Dill-McFarland, Kris Hong, and Yue
  Liu.<br>
  A tutorial by [ECOSCOPE](http://ecoscope.ubc.ca/) at UBC.
date: "version `r format(Sys.time(), '%B %d, %Y')`"
description:  >
  You will learn how to navigate RStudio including data and packages, organize
  your work with scripts and projects, import data from a file or on the web, 
  create and work with basic data types and data structures (vector, data frame,
  etc.) and find help with functions in R.
output: 
  learnr::tutorial:
      progressive: true
      allow_skip: true
...
We will start by using interactive code boxes to perform simple calculator-style operations, such as addition (`+`), subtraction (`-`), multiplication (`*`), division (`/`), or power (`^`).
...
You can examine the first few rows of `dat` using `head(dat)`. Do this in the code box above.
