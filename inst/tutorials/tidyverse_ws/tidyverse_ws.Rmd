...
- The data frame to be pivoted;
- A vector containing the columns that we want to pivot **or** the columns that we do *not* want to pivot (indicated by a minus sign). If this argument is left blank, it defaults to all columns in the data frame except for those specified in `names_from` and `values_from`;
