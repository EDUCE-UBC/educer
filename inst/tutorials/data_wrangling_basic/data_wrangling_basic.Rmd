...
Your resulting pdat object should be a [`r dim(temp)`] data frame. The data has been loaded for you 

```{r summary_exercise, exercise = TRUE, exercise.lines = 5}
dat <- geochemicals
```
### Challenge exercise: `select` and `filter`
If you want more practice or have previous experience in R, try this more challenging exercise! Be sure to create a fresh `pdat`.
