...
```{r dataset_quiz, echo = FALSE}
quiz(
  question("Which colum in the geochemicals dataset has data on average concentration of Hydrogen sulfide for each depth?",
...
lets load the geochemicals dataset into our environment like this:
```{r message=FALSE}
...
```{r intro_exercise, exercise = TRUE, exercise.lines = 5}
