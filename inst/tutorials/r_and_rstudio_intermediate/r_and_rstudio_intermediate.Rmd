...
Of course, all of the functions you'll need will be much more complex than `half()`. In fact, some will be so complex that you'll need *helper functions* to complete the task. In the example below, we have a function that adds 5 to the average of a list of numbers:
