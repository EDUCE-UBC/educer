...
- **List** all keyboard shortcuts for <kbd>H</kbd>elp (including the examples below).
- **Jump** to very beginning with <kbd>G</kbd> and very end with <kbd>Shift + G</kbd>.
- **Scroll** with <kbd>&#8593;</kbd> and <kbd>&#8595;</kbd>. 
- **Page** <kbd>F</kbd>orward and <kbd>B</kbd>ackward a screen at a time.
- **Search** by first pressing <kbd>/</kbd>, then enter your search term followed by <kbd>Return</kbd>. Now you can cycle to the <kbd>N</kbd>ext instance or backwards with <kbd>Shift + N</kbd> (great to search for the effects of flags.).
- **Exit the manual** with <kbd>q</kbd> (for "quit").
